 ...
 *
 * CSV parser class
 * @copyright  Helmut Schottmüller 2012-2015
...
class CsvReader implements \Iterator {
	...
	public function __construct($filename, $separator = ',', $encoding = 'UTF-8') {
	...
	protected function _readLine() {
		...
		$this->currentLine = mb_convert_encoding($this->currentLine, 'UTF-8', $this->encoding);
